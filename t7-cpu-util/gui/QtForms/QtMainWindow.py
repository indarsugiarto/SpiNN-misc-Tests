...
# Form implementation generated from reading ui file 'QtForms/QtMainWindow.ui'
#
...
class Ui_QtMainWindow(object):
    def setupUi(self, QtMainWindow):
        ...
        self.actionShow_Chips = QtGui.QAction(QtMainWindow)
        self.actionShow_Chips.setCheckable(False)
        self.actionShow_Chips.setObjectName(_fromUtf8("actionShow_Chips"))
        self.menuTools.addAction(self.actionShow_Chips)
    ...
    def retranslateUi(self, QtMainWindow):
        QtMainWindow.setWindowTitle(_translate("QtMainWindow", "SpiNN4 Profiler", None))
        self.menuTools.setTitle(_translate("QtMainWindow", "Tools", None))
        ...
        self.actionShow_Chips.setText(_translate("QtMainWindow", "Show Chips", None))
